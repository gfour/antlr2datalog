...
public class Database {
     ...
     * @param outDirPath  the output directory path
     */
    public Database(Map<String, Collection<String>> tables, String outDirPath) {
        this.tables = tables;
    ...
    public void writeFacts() {
        ...
        if (!outDir.mkdirs())
            System.out.println("WARNING: directory already exists: " + outDirPath);
